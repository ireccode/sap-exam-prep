// Node.js script to dynamically generate sitemap.xml for SAPArchitectPrep.com
// Scans the website directory for .html files and outputs sitemap.xml
...
const EXCLUDE_PATHS = [
  'admin', 'dashboard', 'login', 'signup', 'user', 'js', 'css', 'images', '.DS_Store', 'robots.txt', 'generate-sitemap.js'
];
