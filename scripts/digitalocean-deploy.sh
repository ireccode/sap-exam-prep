...
/*
  Content-Security-Policy: default-src 'self' https://*.supabase.co https://openrouter.ai; script-src 'self' 'unsafe-inline' 'unsafe-eval' 'unsafe-hashes' https://js.stripe.com https://seahorse-app-q8fmn.ondigitalocean.app; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; connect-src 'self' https://*.supabase.co wss://*.supabase.co https://openrouter.ai https://api.stripe.com https://formsubmit.co; frame-src 'self' https://js.stripe.com https://hooks.stripe.com; script-src-attr 'unsafe-inline'; form-action 'self' https://formsubmit.co
...
if [ -f "dist/index.html" ]; then
  if ! grep -q "Content-Security-Policy" "dist/index.html"; then
    ...
    sed -i.bak 's/<head>/<head>\n  <meta http-equiv="Content-Security-Policy" content="default-src '\''self'\'' https:\/\/*.supabase.co https:\/\/openrouter.ai; script-src '\''self'\'' '\''unsafe-inline'\'' '\''unsafe-eval'\'' '\''unsafe-hashes'\'' https:\/\/js.stripe.com https:\/\/seahorse-app-q8fmn.ondigitalocean.app; style-src '\''self'\'' '\''unsafe-inline'\''; img-src '\''self'\'' data: https:; connect-src '\''self'\'' https:\/\/*.supabase.co wss:\/\/*.supabase.co https:\/\/openrouter.ai https:\/\/api.stripe.com https:\/\/formsubmit.co; frame-src '\''self'\'' https:\/\/js.stripe.com https:\/\/hooks.stripe.com; script-src-attr '\''unsafe-inline'\''">/' "dist/index.html"
