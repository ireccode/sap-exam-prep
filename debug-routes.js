...
(function() {
  ...
  window.clearRouteHistory = function() {
    ...
    // Clear storage items that might be contributing to the problem
    localStorage.removeItem('ai_chat_current_route');
    localStorage.removeItem('ai_chat_reload_count');
    ...
    console.log('📍 History and storage cleaned');
    return 'History cleanup complete. Refresh the page to see effects.';
  };
